...
import { CustomerListTableColumns } from "../constants/admin-constants";
import InfiniteTable from "../components/InfiniteTable";

import { textEllipsis } from "../utils/string-utils";
import { useGetCustomersMutation } from "../store/apis/user-api-slice";
      ...
      <Paper elevation={3} sx={{ width: "100%", height: "100%" }}>
        ...
        >
          ...
          >
            ...
            <InfiniteTable<CustomerListTableItem>
              search={search}
              useGetDataMutation={useGetCustomersMutation}
